...
class CrossProduct(ThreeDScene):
    ...
    def construct(self):
        ...
        self.add_fixed_in_frame_mobjects(title, basis_vectors_text)
        self.play(Write(title), run_time=3)
        ...
        #     MathTex("\\mathbf{e}_1", color=CONFIG["basis_i_color"], font_size=int(3 * TITLE_FONTSIZE / 3)),
        #     MathTex("\\mathbf{e}_2", color=CONFIG["basis_j_color"], font_size=int(3 * TITLE_FONTSIZE / 3)),
        #     MathTex("\\mathbf{e}_3", color=CONFIG["basis_k_color"], font_size=int(3 * TITLE_FONTSIZE / 3)),
        # )

        # # Ensure labels are always facing the camera
        # for label in labels:
        ...
        # Color the basis vectors text
        # basis_vectors_text.set_color_by_tex(
        #     "\\mathbf{e}_1", CONFIG["basis_i_color"]
        # )
        # basis_vectors_text.set_color_by_tex(
        #     "\\mathbf{e}_2", CONFIG["basis_j_color"]
        # )
        # basis_vectors_text.set_color_by_tex(
        #     "\\mathbf{e}_3", CONFIG["basis_k_color"]
        # )
        
        # Redraw the vectors text with the new colors
        # self.play(
        #     Transform(basis_vectors_text, basis_vectors_text.copy().set_color_by_tex(
        #         "\\mathbf{e}_1", CONFIG["basis_i_color"]
        #     )),
        #     Transform(basis_vectors_text, basis_vectors_text.copy().set_color_by_tex(
        #         "\\mathbf{e}_2", CONFIG["basis_j_color"]
        ...
        # self.begin_ambient_camera_rotation(
            # rate=PI/16, about="theta")
        # self.wait(PAUSE_WAIT_TIME)
        

        # * ______________________________________________________________________
        self.next_section("Basis Vectors", skip_animations=True)
        # * ______________________________________________________________________
        ...
        for vector in [i_hat, j_hat, k_hat]:
            vector.z_index = 10  # Ensure the vectors are on top of the axes
            self.play(
                Create(vector, run_time=1),
            )
        ...
        # pseudoscalar.z_index = 10
        # self.remove_fixed_in_frame_mobjects(wedge_text)
        ...
        # * ______________________________________________________________________
        self.next_section("Multivectors", skip_animations=True)
        # * ______________________________________________________________________ 
