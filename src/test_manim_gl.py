...
class OpenGLIntro(Scene):
    def construct(self):
        ...
        case3_tex.move_to(case2_tex.get_center()).shift(RIGHT*7)
        ...
        self.play(
            TransformMatchingTex(case_3_levi_civita.copy(), case_3_levi_civita_pseudo),
            run_time=3
        )
        ...
        self.play(
            TransformMatchingTex(case_3_levi_civita_pseudo, case_3_levi_civita_pseudo_2),
            run_time=3
        )
        ...
        # # Draw two vectors and their parallogram
        # vector_a = Arrow3D(start=ORIGIN, end=[1, 2, 0], color=YELLOW)
        # vector_b = Arrow3D(start=ORIGIN, end=[2, 1, 0], color=RED)
        
        # parallelogram = Polygon(ORIGIN, vector_a.get_end(), vector_a.get_end() + vector_b.get_end(), vector_b.get_end(), color=GREEN, fill_opacity=0.5)
        # parallelogram.set_fill(GREEN, opacity=0.5)
        # parallelogram.set_stroke(width=0)
        # parallelogram.set_opacity(0.5)
        
        # self.play(Create(vector_a), Create(vector_b), run_time=2)
        # self.wait(1)
        # self.play(Create(parallelogram), run_time=2)
        # self.wait(1)