    ...
    def construct(self):
        ...
        A_wedge_B_summation_notation =Tex(
            ...
            *A_term_sum, space, wedge, space, *B_term_sum,
            ...
            # additional_preamble=r"\usepackage{amsfonts}",
            additional_preamble=r"\usepackage{amssymb}",
        ...
        def generate_line(self, line_num, term):
            ...
            self.play(
                TransformMatchingTex(expanded_sum.copy().set_opacity(0), group_lines[line_num], run_time=6, path_arc=5*DEGREES, 
                                        key_map=km,
                                    lag_ratio=.4,
        ...
        self.play(
            TransformMatchingTex(new_line_1_reorder_wedge, new_line_1_scalars, run_time=2, path_arc=90*DEGREES, lag_ratio=0.1, key_map={wedge:wedge, plus:plus}),
            TransformMatchingTex(new_line_2_reorder_wedge, new_line_2_scalars, run_time=2, path_arc=90*DEGREES, lag_ratio=0.1, key_map={wedge:wedge, plus:plus}),
            TransformMatchingTex(new_line_3_reorder_wedge, new_line_3_scalars, run_time=2, path_arc=90*DEGREES, lag_ratio=0.1, key_map={wedge:wedge, plus:plus}),
        ...
        self.play(
            TransformMatchingShapes(new_line_1_scalars, new_line_1_flip_wedge, run_time=3, path_arc=115*DEGREES),
            TransformMatchingShapes(new_line_2_scalars, new_line_2_flip_wedge, run_time=3, path_arc=115*DEGREES),
            TransformMatchingShapes(new_line_3_scalars, new_line_3_flip_wedge, run_time=3, path_arc=115*DEGREES),
        ...
        self.play(
            TransformMatchingShapes(new_line_1_flip_wedge, new_line_1_flip_wedge_grouped, run_time=3, path_arc=115*DEGREES),
            TransformMatchingShapes(new_line_2_flip_wedge, new_line_2_flip_wedge_grouped, run_time=3, path_arc=115*DEGREES),
            TransformMatchingShapes(new_line_3_flip_wedge, new_line_3_flip_wedge_grouped, run_time=3, path_arc=115*DEGREES),
        ...
        self.play(
            TransformMatchingTex(e1_wedge_e2_copy, e1_wedge_e2_copy_2, lag_ratio=0.3),
            run_time=3
        )
        self.wait(NOMINAL_WAIT_TIME)
        ...
        self.play(
            TransformMatchingShapes(e1_wedge_e2_copy_2, e1_wedge_e2_geo_prod, run_time=2)
        )
        self.wait(NOMINAL_WAIT_TIME)
        ...
        e1_wedge_e2_geo_prod_extended.move_to(e1_wedge_e2_geo_prod.get_center()).shift(RIGHT*0.5)

                
        self.play(
            TransformMatchingTex(e1_wedge_e2_geo_prod, e1_wedge_e2_geo_prod_extended, run_time=2,
                                 lag_ratio=0.3,)
        )
        self.wait(NOMINAL_WAIT_TIME)
        ...
        e1_wedge_e2_geo_prod_extended_rearranged.move_to(e1_wedge_e2_geo_prod_extended.get_center()).shift(RIGHT*0.5)
        ...
        e1_wedge_e2_geo_prod_levi_civita.move_to(e1_wedge_e2_geo_prod_extended_rearranged.get_center()).shift(RIGHT*0.5)
        
        self.play(
            TransformMatchingTex(e1_wedge_e2_geo_prod_extended_rearranged, e1_wedge_e2_geo_prod_levi_civita, run_time=2, lag_ratio=0.3,)
        )
        self.wait(NOMINAL_WAIT_TIME)
        ...
        e1_wedge_e2_geo_prod_cross = Tex(e1, space, wedge, space, e2, space, equal, space,
                                               lbracket, e1, space, "\\times", space, e2, rbracket,
                                                space, I)
        # Color the e3 with Green
        e1_wedge_e2_geo_prod_cross.set_color_by_tex(I, BLUE_B)
        e1_wedge_e2_geo_prod_cross.move_to(e1_wedge_e2_geo_prod_levi_civita.get_center()).shift(RIGHT*0.5)
        
        self.play(
            Transform(e1_wedge_e2_geo_prod_levi_civita, e1_wedge_e2_geo_prod_cross, run_time=2)
        )
        self.wait(NOMINAL_WAIT_TIME)
        ...
        e1_wedge_e2_geo_prod_I = Tex(e1, space, wedge, space, e2, space, equal, space,
                                               lbracket, e1, space, "\\times", space, e2, rbracket,
                                                space, "TEST")
        # Color the e3 with Green
        e1_wedge_e2_geo_prod_I.set_color_by_tex(I, BLUE_B)
        e1_wedge_e2_geo_prod_I.move_to(e1_wedge_e2_geo_prod_cross.get_center()).shift(LEFT*0.5)
        
        
        
        self.play(
            # FadeOut(e1_wedge_e2_geo_prod_cross),
            # ReplacementTransform(e1_wedge_e2_geo_prod_cross, e1_wedge_e2_geo_prod_I, run_time=2)
            TransformMatchingTex(e1_wedge_e2_geo_prod_cross, e1_wedge_e2_geo_prod_I, run_time=2)
        )
        self.remove(e1_wedge_e2_geo_prod_cross)
        ...
        # # * Line 1        
        # self.play(
        #     Indicate(expanded_sum[a1], scale_factor=1.5),
        #     Indicate(expanded_sum[b1], scale_factor=1.5),
        #     Indicate(expanded_sum[b2], scale_factor=1.5),
        #     Indicate(expanded_sum[b3], scale_factor=1.5),
        # )
        ...
        # self.play(
        #     TransformMatchingTex(expanded_sum.copy().set_opacity(0), group_lines[0], run_time=6, path_arc=5*DEGREES, 
        #                          key_map={
        ...
        # # * Line 2        
        # self.play(
        #     Indicate(expanded_sum[a2], scale_factor=1.5),
        #     Indicate(expanded_sum[b1], scale_factor=1.5),
        #     Indicate(expanded_sum[b2], scale_factor=1.5),
        #     Indicate(expanded_sum[b3], scale_factor=1.5),
        # )
        # self.wait(0.5) 
        # self.play(
        #     TransformMatchingTex(expanded_sum.copy().set_opacity(0), group_lines[1], run_time=6, path_arc=5*DEGREES, 
        #                          key_map={
        ...
        # # * Line 3     
        # self.play(
        #     Indicate(expanded_sum[a3], scale_factor=1.5),
        #     Indicate(expanded_sum[b1], scale_factor=1.5),
        #     Indicate(expanded_sum[b2], scale_factor=1.5),
        #     Indicate(expanded_sum[b3], scale_factor=1.5),
        # )
        # self.wait(0.5) 
        # empty_list = [space, space]*(len(A_sum_expanded) - 3)
        
        # expanded_sum_copy3 = Tex(
        #     equal, space,
        #     *empty_list, *A_sum_expanded[-3:-2], space, space, wedge, space, *B_sum_expanded,
        #     isolate=individual_terms,
        # ).to_edge(UP).shift(DOWN * 1).set_opacity(0)
        
        # self.play(
        #     TransformMatchingTex(expanded_sum.copy().set_opacity(0), group_lines[2], run_time=6, path_arc=5*DEGREES, 
        #                          key_map={
